...
_DISABLED_BY_DEFAULT_MSG = """

The APPMAP environment variable is unset. Your code will NOT instrumented or
recorded.

To create AppMap data files, use the appmap-python script to run your
application, or explicitly set APPMAP.

Visit https://appmap.io/docs/reference/appmap-python.html#appmap-python-script
for more details.
"""
...
_appmap_enabled = os.environ.get("APPMAP")
if _appmap_enabled is not None:
    if _appmap_enabled.upper() == "TRUE":
